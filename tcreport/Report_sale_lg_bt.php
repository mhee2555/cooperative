...
class MYPDF extends TCPDF
{
  ...
  public function Header()
  {
    ...
    if ($this->page == 1)
    {
      ...
      $this->Cell(0, 10,  "รายงานการขายลำไย", 0, 1, 'C');
...
<th  width="13 %" align="center">สถานะ</th>
  ...
  $Sql_Detail="SELECT
                sale_longan.DocDate,
                sale_longan.DocNo,
                SUM(sale_longan_detail.kilo) AS total_qty,
                ...
                INNER JOIN employee ON sale_longan.Employee_ID = employee.ID
                WHERE
                DATE(sale_longan.DocDate) BETWEEN '$sDate' AND '$eDate'
                GROUP BY
                sale_longan.DocNo
                ORDER BY
                DATE(sale_longan.DocDate) ASC      ";
              $sump=0;
              $sumqty=0;
