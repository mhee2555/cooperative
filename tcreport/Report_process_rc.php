...
class MYPDF extends TCPDF
{
  ...
  public function Header()
  {
    ...
    if ($this->page == 1)
    {
      ...
      $this->Cell(0, 10,  "รายงานการแปรรูปข้าว", 0, 1, 'C');
...
<th  width="10 %" align="center">สถานะ</th>
  ...
  $Sql_Detail="SELECT
                ...
                INNER JOIN item_unit ON item_unit.UnitCode = process_rice_detail.UnitCode
                INNER JOIN employee ON employee.ID = process_rice.Employee_ID
                WHERE
                DATE( process_rice.DocDate ) BETWEEN '$sDate' AND '$eDate'
                AND process_rice.IsRef_Status=1
                GROUP BY
                process_rice.DocNo
