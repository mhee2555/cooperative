...
<th  width="12 %" align="center">เวลา</th>
...
<th  width="10 %" align="center">สถานะ</th>
  ...
  $Sql_Detail="SELECT
                ...
                WHERE
                DATE(stock_unprocess.Date_start ) BETWEEN '$sDate' AND '$eDate'
                
                GROUP BY DATE(stock_unprocess.Date_start)
                ORDER BY
                DATE(stock_unprocess.Date_start) ASC ,stock_unprocess.DocNo ASC
              ";
              $sump=0;
              $sumqty=0;
...
while ($Result_Detail = mysqli_fetch_assoc($meQuery2)) {
  ...
  $html .=   '<td width="11 %" align="center"> '.$Result_Detail['date_s'].'</td>';
