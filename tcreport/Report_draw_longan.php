...
class MYPDF extends TCPDF
{
  ...
  public function Header()
  {
    ...
    if ($this->page == 1)
    {
      ...
      $this->Cell(0, 10,  "เอกสารขอเบิกลำไย", 0, 1, 'C');
      $this->Ln(10);
...
<th  width="20 %" align="center">รหัสคลังสินค้า</th>
  ...
  $Sql_Detail="SELECT
              ...
              INNER JOIN stock_unprocess ON draw_detail_sub.stock_code = stock_unprocess.stock_code
              WHERE
              draw_detail_sub.draw_DocNo = '$DocNo'
              ";
