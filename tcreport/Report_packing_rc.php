...
class MYPDF extends TCPDF
{
  ...
  public function Header()
  {
    ...
    if ($this->page == 1)
    {
      ...
      $this->Cell(0, 10,  "เอกสารสั่งบรรจุภัณฑ์ข้าว", 0, 1, 'C');
      $this->Ln(10);
...
<th  width="20 %" align="center">รหัสคลังสินค้า</th>
  ...
  $Sql_Detail="SELECT
                ...
                FROM
                packing_rice_detail
                INNER JOIN item ON packing_rice_detail.item_code = item.item_code 
                INNER JOIN packge_unit ON packing_rice_detail.UnitCode = packge_unit.PackgeCode
                INNER JOIN stock_process ON packing_rice_detail.stock_code = stock_process.stock_code
                WHERE
                packing_rice_detail.Pk_DocNo = '$DocNo'
              ";
