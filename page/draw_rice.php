                        ...
                        $( "#Tableitem tbody" ).empty();
                              for (var i = 0; i < temp['Row']; i++) 
                              {
                                var chkunit ="<select  class='form-control' style='width: 100px;'  id='iUnit_"+i+"'>";
                                  ...
                                  var draw = "<input type='text' id='draw_"+i+"' class='form-control numonly' autocomplete='off'  placeholder='0.00' onkeyup='Sumitem(\""+temp[i]['item_ccqty']+"\" , \""+i+"\" ) '>  ";
