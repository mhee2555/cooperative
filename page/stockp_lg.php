...
<head>
    ...
    <title>บันทึกการรับเข้าลำไยแปรรูป</title>
    <!-- CSS -->
   ...
   var docdate = $("#docdate").val();
       ...
       url = "../tcreport/Report_stockp_lg.php?eDate=" + docdate +"&DocNo=" + DocNo+"&Employee=" + Employee;
       window.open(url);
